...
/** Connect / disconnect your own Anthropic key. Opens from the header.
...
export function KeySettings({ onClose }: { onClose: () => void }) {
    ...
    >
      ...
      >
        <div className="flex items-baseline justify-between">
          <h2 className="font-serif text-xl italic text-ink">Your Anthropic key</h2>
          <button
            onClick={onClose}
        ...
        {saved ? (
          <div className="mt-4 space-y-4">
            ...
            <p className="text-[13px] leading-relaxed text-ink-soft">
              Requests bill your account. The key is stored in this browser only and sent per
