...
/** Single source of truth for prices. USD per 1M tokens. Verified against
 *  https://platform.claude.com/docs/en/about-claude/pricing on this date. */
...
export const PRICING: Record<
  ModelId,
  {
    ...
    label: string;
    /** Flat cache-read price where a model departs from the standard 0.1×
     *  input-rate multiplier (Fable 5.1: $0.25/MTok = 0.025×). */
    cacheReadPerMTok?: number;
  }
> = {
  "claude-haiku-4-5": { inputPerMTok: 1.0, outputPerMTok: 5.0, label: "Haiku 4.5" },
  "claude-sonnet-5": { inputPerMTok: 2.0, outputPerMTok: 10.0, label: "Sonnet 5" },
 ...
 *  A model may override the read price via `cacheReadPerMTok`. */
